...
<div class="main_content_iner ">
    <div class="col-lg-12">
        ...
        <h3 class="m-0">Donation Message</h3>
        </div>
           ...
           <div class="row mb-3">
            <div class="col-md-12">
               <div class="form-group translate">
                   ...
                   <input type="text" class="form-control" value='{{ $message->company_name }}'>
               </div>
            </div>
           </div>
           <div class="row mb-3">
        ...
        <a href="{{ route('donationmessage.index') }}" class="btn btn-success">Back</a>
        </form>
        </div>
        </div>
        </div>
