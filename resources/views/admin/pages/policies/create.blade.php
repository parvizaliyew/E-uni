            ...
            <div class="col-md-4">
               <div class="form-group">
                   ...
                   <select name="type" class="form-control">
                    ...
                    <option value="1">Regulations / General University Policies</option>
                    <option value="2">Regulations /Student Accounts and Financial Aid</option>
                    <option value="3">Academic Policies</option>
                   </select>
               </div>
               @error('type')
