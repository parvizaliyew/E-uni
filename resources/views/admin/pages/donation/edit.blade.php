...
<div class="main_content_iner ">
    <div class="col-lg-12">
        ...
        <h3 class="m-0">Donation Update</h3>
        </div>
        ...
        <div class="card-body">
        <form method="POST" enctype="multipart/form-data" action="{{ route('donations.update', $donation->id) }}">
        @csrf
        @method("PUT")
        <div class="row mb-3">
        <div class="col-md-6">
            <label class="form-group" for="">Image</label> <br>
            <img width="400px" height="300px" src="{{ asset($donation->img) }}" alt=""> 
            <div class="mb-3">
                <br>
        ...
        <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        <input name="date" class="form-control" value="{{ $donation->date }}" type="date" id="Inputdate">
                    </div>
                    @error('date')
                    <span class="text-danger mt-2">{{ $message }}</span> 
                    @enderror
        ...
        <div class="row mb-3">
         <div class="col-md-12">
            <div class="form-group translate">
                ...
                <input value="{{ $donation->translate('name') }}" class="form-control">
            </div>
            @error('name')
