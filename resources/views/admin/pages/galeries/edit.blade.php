...
<div class="main_content_iner ">
    <div class="col-lg-12">
        ...
        <div class="card-body">
        <form method="POST" enctype="multipart/form-data" action="{{ route('galery.update',$galery->id) }}">
        @csrf
        @method("PUT")
         <div class="row mb-3">
        <div class="col-md-6">
        ...
        <a href="{{ route('galery.index') }}" class="btn btn-success">Back</a>
